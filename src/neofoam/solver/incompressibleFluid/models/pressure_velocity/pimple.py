...
from .base import ensure_pressure_reference, register_pressure_velocity_algorithm
...
@register_pressure_velocity_algorithm("PIMPLE")
class PimplePressureVelocityAlgorithm:
    ...
    def momentum(
        ...
        if model_state.use_boussinesq:
            if p_rgh is None or rhok is None or ghf is None:
                raise RuntimeError(
                    "Boussinesq mode requires p_rgh, rhok, and ghf fields"
                )
