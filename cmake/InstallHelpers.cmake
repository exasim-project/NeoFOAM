...
set(NEOFOAM_INSTALL_MODULE_DIR
    "${CMAKE_INSTALL_FULL_LIBDIR}/cmake/NeoFOAM/Modules")

function(neofoam_install)
  install(
    TARGETS NeoFOAM
    EXPORT NeoFOAMTargets
  ...
  configure_file(
    ...
    "${CMAKE_CURRENT_BINARY_DIR}/NeoFOAM/NeoFOAMConfig.cmake" COPYONLY)

  if(NOT ${Kokkos_FOUND} OR ${FORCE_NEOFOAM_BUILD_KOKKOS})
    install(TARGETS kokkos kokkoscore kokkoscontainers kokkosalgorithms
                    kokkossimd LIBDL EXPORT NeoFOAMTargets)
  ...
  install(
    EXPORT NeoFOAMTargets
    FILE NeoFOAMTargets.cmake
    DESTINATION ${ConfigPackageLocation})
  install(
    FILES cmake/NeoFOAMConfig.cmake
          "${CMAKE_CURRENT_BINARY_DIR}/NeoFOAM/NeoFOAMConfigVersion.cmake"
    DESTINATION ${ConfigPackageLocation}
    COMPONENT Devel)
endfunction()
