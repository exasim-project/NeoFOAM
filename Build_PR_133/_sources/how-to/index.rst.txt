...
Goal-oriented recipes. Each page answers one question and assumes you
already know what you're trying to do. For an end-to-end learning path,
see the :doc:`tutorials </auto_tutorials/index>` instead.
