...
# compile petsc
make PETSC_DIR=/home/michael/testPetscConfgigureCompile/test_script/petsc PETSC_ARCH=arch-linux-c-opt all

#install petsc
make PETSC_DIR=/home/michael/testPetscConfgigureCompile/test_script/petsc PETSC_ARCH=arch-linux-c-opt install
