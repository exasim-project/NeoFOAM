...
public:
     ...
     *
     * Looks up the pressure field @c pName_ from the OpenFOAM object registry,
     * converts it to a NeoN field on the active executor, then accumulates
     * pressure forces and moments for each registered patch via a
