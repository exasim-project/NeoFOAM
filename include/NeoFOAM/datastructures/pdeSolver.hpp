...
public:
    ...
    )
    {
        ...
        jl_function_t* func = jl_get_function(mod, "assemble");
    ...
    //                 (phiV[faceIdx] >= 0) ? 0.0 : 1.0; // weightsV[faceIdx]; const auto lapFlux =
    //                 deltaV[faceIdx] * gammaV[faceIdx] * magFaceAreaV[faceIdx]; const auto
