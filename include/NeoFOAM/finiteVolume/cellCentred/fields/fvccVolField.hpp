 ...
 *
 * The fvccVolField class is used to store field information at the cell center.
...
private:
    ...
    domainField<T> field_;         /**< The domain field. */
    std::vector<std::unique_ptr<fvccBoundaryField<T>>>
