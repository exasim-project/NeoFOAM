...
int main(int argc, char* argv[])
{
    ...
    if (check_flag(&flag, "PrintUserData", 1))
    {
        return 1;
    }
    ...
    if (udata->diagnostics || udata->lsinfo)
    {
        ...
        if (check_flag(&flag, "SUNContext_GetLogger", 1))
        {
            return 1;
        }

        flag = SUNLogger_SetInfoFilename(logger, "diagnostics.txt");
        if (check_flag(&flag, "SUNLogger_SetInfoFilename", 1))
        {
            return 1;
        }
    ...
    udata->e = N_VClone(u);
    if (check_flag((void*)(udata->e), "N_VClone", 0))
    {
        return 1;
    }
    ...
    {
        udata->d = N_VClone(u);
        if (check_flag((void*)(udata->d), "N_VClone", 0))
        {
            return 1;
        }
    }
    ...
    if (check_flag(&flag, "ARKodeSetLinearSolver", 1))
    {
        return 1;
    }
    ...
    if (udata->prec)
    {
        ...
        if (check_flag(&flag, "ARKodeSetPreconditioner", 1))
        {
            return 1;
        }
        ...
        if (check_flag(&flag, "ARKodeSetLSetupFrequency", 1))
        {
            return 1;
        }
    }
    ...
    if (check_flag(&flag, "ARKodeSetEpsLin", 1))
    {
        return 1;
    }
    ...
    if (udata->order > 1)
    {
        ...
        if (check_flag(&flag, "ARKodeSetOrder", 1))
        {
            return 1;
        }
    }
    else
    {
        ...
        if (check_flag((void*)B, "ARKodeButcherTable_Create", 0))
        {
            return 1;
        }
        ...
        if (check_flag(&flag, "ARKStepSetTables", 1))
        {
            return 1;
        }
    ...
    if (udata->hfixed > ZERO)
    {
        ...
        if (check_flag(&flag, "ARKodeSetFixedStep", 1))
        {
            return 1;
        }
    }
    else
    {
        ...
        case (ARK_ADAPT_EXP_GUS):
            C = SUNAdaptController_ExpGus(ctx);
            break;
        case (ARK_ADAPT_IMP_GUS):
            C = SUNAdaptController_ImpGus(ctx);
            break;
        case (ARK_ADAPT_IMEX_GUS):
            C = SUNAdaptController_ImExGus(ctx);
            break;
        }
        flag = ARKodeSetAdaptController(arkode_mem, C);
        if (check_flag(&flag, "ARKodeSetAdaptController", 1))
        {
            return 1;
        }
    }
    ...
    if (udata->linear)
    {
        ...
        if (check_flag(&flag, "ARKodeSetLinear", 1))
        {
            return 1;
        }
    }
    ...
    if (check_flag(&flag, "ARKodeSetStopTime", 1))
    {
        return 1;
    }
    ...
    if (check_flag(&flag, "OpenOutput", 1))
    {
        return 1;
    }

    flag = WriteOutput(t, u, udata);
    if (check_flag(&flag, "WriteOutput", 1))
    {
        return 1;
    }
    ...
    if (check_flag(&flag, "CloseOutput", 1))
    {
        return 1;
    }
    ...
    if (udata->output > 0)
    {
        ...
        if (check_flag(&flag, "OutputStats", 1))
        {
            return 1;
        }
    }
    ...
    if (udata->forcing)
    {
        ...
        if (check_flag(&flag, "SolutionError", 1))
        {
            return 1;
        }
    ...
    if (udata->timing)
    {
        ...
        if (check_flag(&flag, "OutputTiming", 1))
        {
            return 1;
        }
    }
...
static int f(sunrealtype t, N_Vector u, N_Vector f, void* user_data)
{
    ...
    if (check_flag((void*)uarray, "N_VGetArrayPointer", 0))
    {
        return -1;
    }

    sunrealtype* farray = N_VGetArrayPointer(f);
    if (check_flag((void*)farray, "N_VGetArrayPointer", 0))
    {
        return -1;
    }
    ...
    if (udata->forcing)
    {
        ...
        for (sunindextype j = 1; j < ny - 1; j++)
        {
            for (sunindextype i = 1; i < nx - 1; i++)
            {
                ...
                farray[IDX(i, j, nx)] = -TWO * PI * sin_sqr_x * sin_sqr_y * sin_t_cos_t
...
)
{
    ...
    if (check_flag((void*)diag, "N_VGetArrayPointer", 0))
    {
        return -1;
    }
...
static int OpenOutput(UserData* udata)
{
    ...
    if (udata->output == 2)
    {
        ...
        ofstream doubt;
        doubt.open("heat2d_info.txt");
        doubt << "xu  " << udata->xu << endl;
        doubt << "yu  " << udata->yu << endl;
        doubt << "nx  " << udata->nx << endl;
        doubt << "ny  " << udata->ny << endl;
        doubt << "nt  " << udata->nout + 1 << endl;
        doubt.close();
    ...
    if (udata->output > 0)
    {
        ...
        if (udata->output == 2)
        {
            ...
            if (udata->forcing)
            {
                ...
                if (check_flag((void*)earray, "N_VGetArrayPointer", 0))
                {
                    return -1;
                }
...
static int OutputStats(void* arkode_mem, UserData* udata)
{
    ...
    if (check_flag(&flag, "ARKodeGetNumStepAttempts", 1))
    {
        return -1;
    }
    ...
    if (check_flag(&flag, "ARKStepGetNumRhsEvals", 1))
    {
        return -1;
    }
    flag = ARKodeGetNumNonlinSolvIters(arkode_mem, &nni);
    if (check_flag(&flag, "ARKodeGetNumNonlinSolvIters", 1))
    {
        return -1;
    }
    ...
    if (check_flag(&flag, "ARKodeGetNumLinIters", 1))
    {
        return -1;
    }
    flag = ARKodeGetNumLinConvFails(arkode_mem, &nlcf);
    if (check_flag(&flag, "ARKodeGetNumLinConvFails", 1))
    {
        return -1;
    }
    flag = ARKodeGetNumLinSolvSetups(arkode_mem, &nsetups);
    if (check_flag(&flag, "ARKodeGetNumLinSolvSetups", 1))
    {
        return -1;
    }
    flag = ARKodeGetNumLinRhsEvals(arkode_mem, &nfi_ls);
    if (check_flag(&flag, "ARKodeGetNumLinRhsEvals", 1))
    {
        return -1;
    }
    flag = ARKodeGetNumJtimesEvals(arkode_mem, &nJv);
    if (check_flag(&flag, "ARKodeGetNumJtimesEvals", 1))
    {
        return -1;
    }
    ...
    if (udata->prec)
    {
        ...
        if (check_flag(&flag, "ARKodeGetNumPrecEvals", 1))
        {
            return -1;
        }
        flag = ARKodeGetNumPrecSolves(arkode_mem, &nps);
        if (check_flag(&flag, "ARKodeGetNumPrecSolves", 1))
        {
            return -1;
        }
