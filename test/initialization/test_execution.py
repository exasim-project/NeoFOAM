...
def test_build_context_routing(init_results, check):
...
def test_build_context_resource_routing():
...
def test_init_step_execution_error_wraps_cause():
    """InitStep.execute() wraps initializer exceptions with step context."""

    def failing_init(_ctx):
...
def test_init_step_execution_error_preserves_value_error():
