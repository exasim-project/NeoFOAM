...
class AlgorithmConfig(BaseModel):
    ...
    n_outer_correctors: int = Field(default=1, ge=1, description="Number of outer correctors")
...
class PressureEquationBuoyant:
    ...
    def get_operations(self) -> list[str]:
        return ["assemble_momentum", "add_buoyancy", "solve_pressure_buoyant", "correct_velocity"]
...
class AdaptivePressureModel(BaseModel):
    ...
    _implementations = {
        False: PressureEquationStandard,
        True: PressureEquationBuoyant
    }
