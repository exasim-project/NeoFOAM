...
TEST_CASE("getType")
{
    ...
    REQUIRE(getType<bool>() == MPI_C_BOOL);
    REQUIRE(getType<std::complex<float>>() == MPI_C_FLOAT_COMPLEX);
    REQUIRE(getType<std::complex<double>>() == MPI_C_DOUBLE_COMPLEX);
    REQUIRE(getType<std::complex<long double>>() == MPI_C_LONG_DOUBLE_COMPLEX);
}
